...
namespace JumpingDude
{
    public partial class Form1 : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            {
                player.Image = Image.FromFile("MoveRight.gif");
            }
            if (left == true && index % 15 == 0)
            {
                player.Image = Image.FromFile("MoveLeft.gif");
            }
            //
            ...
            if (player.Top + player.Height >= screen.Height)
            {
                ...
                if (jump == true)
                {
                   player.Image = Image.FromFile("StandRight.png");
                }
                jump = false;
        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (jump != true)
            {
                if (e.KeyCode == Keys.Space)
                {
                    jump = true;
                    Force = G;
                    player.Image = Image.FromFile("jumpRight.gif");
                }
            }
        }
        ...
        private void Form1_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                left = false;
                player.Image = Image.FromFile("StandLeft.png");
            }
        }
    }
}
